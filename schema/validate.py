...
CURRENT_PINS = {
    ...
    "pr_poll": "fm-pr-poll.v1",
    "pr_reviewers": "fm-pr-reviewers.v1",
    "arm_policy_check": "fm-arm-pretool-check.classify.v1",
    "cd_policy_check": "fm-cd-pretool-check.classify.v1",
    "subagent_policy_check": "fm-subagent-pretool-check.classify.v1",
    "supervision_instructions": "fm-supervision-instructions.render.v1",
    "quota_choose": "fm-quota-choose.select.v1",
    "relay_poll": "fm-x-poll.v1",
    "grant_mint": "mcp-grant.v1",
    "grant_revoke": "mcp-grant.v1",
    "beads_backend": "fm-beads.backend.v1",
    "beads_scope": "fm-beads.scope.v1",
    ...
    "reap_triage": "fm-agent-axi.v1",
    "coderabbit_state": "fm-coderabbit.v1",
