...
test_home_seed_no_projects_end_to_end() {
  ...
  PATH="$fakebin:$PATH" FM_HOME="$home" FM_FAKE_TMUX_LOG="$log" \
    ...
    "$ROOT/bin/fm-spawn.sh" fdev "$sub" codex --secondmate --model gpt-5 >/dev/null 2>&1 \
...
test_secondmate_spawn_resolves_punctuated_registry_projects() {
  ...
  PATH="$fakebin:$PATH" FM_HOME="$home" FM_FAKE_TMUX_LOG="$log" \
    ...
    "$ROOT/bin/fm-spawn.sh" punctuated codex --secondmate --model gpt-5 >/dev/null 2>&1 \
...
SH
  ...
  if PATH="$fakebin:$PATH" FM_HOME="$home" FM_FAKE_TMUX_LOG="$log" FM_FAKE_TMUX_CAPTURE="$TMP_ROOT/spawn-validate-fake/pane.txt" \
    "$ROOT/bin/fm-spawn.sh" domain "$subhome" codex --secondmate --model gpt-5 >/dev/null 2>"$err"; then
  ...
  if PATH="$fakebin:$PATH" FM_HOME="$home" FM_FAKE_TMUX_LOG="$log" FM_FAKE_TMUX_CAPTURE="$TMP_ROOT/spawn-validate-fake/pane.txt" \
    "$ROOT/bin/fm-spawn.sh" domain "$wronghome" codex --secondmate --model gpt-5 >/dev/null 2>"$err"; then
  ...
  if PATH="$fakebin:$PATH" FM_HOME="$home" FM_FAKE_TMUX_LOG="$log" FM_FAKE_TMUX_CAPTURE="$TMP_ROOT/spawn-validate-fake/pane.txt" \
    "$ROOT/bin/fm-spawn.sh" domain "$marker_only" codex --secondmate --model gpt-5 >/dev/null 2>"$err"; then
  ...
  if PATH="$fakebin:$PATH" FM_HOME="$home" FM_FAKE_TMUX_LOG="$log" FM_FAKE_TMUX_CAPTURE="$TMP_ROOT/spawn-validate-fake/pane.txt" \
    "$ROOT/bin/fm-spawn.sh" domain "$home" codex --secondmate --model gpt-5 >/dev/null 2>"$err"; then
  ...
  if PATH="$fakebin:$PATH" FM_HOME="$home" FM_FAKE_TMUX_LOG="$log" FM_FAKE_TMUX_CAPTURE="$TMP_ROOT/spawn-validate-fake/pane.txt" \
    "$ROOT/bin/fm-spawn.sh" domain "$ROOT" codex --secondmate --model gpt-5 >/dev/null 2>"$err"; then
  ...
  if PATH="$fakebin:$PATH" FM_HOME="$home" FM_FAKE_TMUX_LOG="$log" FM_FAKE_TMUX_CAPTURE="$TMP_ROOT/spawn-validate-fake/pane.txt" \
    "$ROOT/bin/fm-spawn.sh" domain "$active_descendant" codex --secondmate --model gpt-5 >/dev/null 2>"$err"; then
  ...
  if PATH="$fakebin:$PATH" FM_HOME="$ancestor_active_home" FM_FAKE_TMUX_LOG="$log" FM_FAKE_TMUX_CAPTURE="$TMP_ROOT/spawn-validate-fake/pane.txt" \
    "$ROOT/bin/fm-spawn.sh" domain "$active_ancestor" codex --secondmate --model gpt-5 >/dev/null 2>"$err"; then
  ...
  if PATH="$fakebin:$PATH" FM_ROOT_OVERRIDE="$fakeroot" FM_HOME="$home" FM_FAKE_TMUX_LOG="$log" FM_FAKE_TMUX_CAPTURE="$TMP_ROOT/spawn-validate-fake/pane.txt" \
    "$ROOT/bin/fm-spawn.sh" domain "$root_descendant" codex --secondmate --model gpt-5 >/dev/null 2>"$err"; then
  ...
  if PATH="$fakebin:$PATH" FM_ROOT_OVERRIDE="$root_inside" FM_HOME="$home" FM_FAKE_TMUX_LOG="$log" FM_FAKE_TMUX_CAPTURE="$TMP_ROOT/spawn-validate-fake/pane.txt" \
    "$ROOT/bin/fm-spawn.sh" domain "$root_ancestor" codex --secondmate --model gpt-5 >/dev/null 2>"$err"; then
...
test_secondmate_spawn_requires_registering_home() {
  ...
  printf -- '- domain - domain (home: %s; scope: domain work; projects: ; added 2026-08-05)\n' "$elsewhere" \
    > "$home/data/secondmates.md"
  if PATH="$fakebin:$PATH" FM_HOME="$home" FM_FAKE_TMUX_LOG="$log" FM_FAKE_TMUX_CAPTURE="$TMP_ROOT/spawn-registry-fake/pane.txt" \
    "$ROOT/bin/fm-spawn.sh" domain "$subhome_abs" codex --secondmate --model gpt-5 >/dev/null 2>"$err"; then
...
test_fresh_remote_secondmate_spawn_refuses_while_task_set_is_owned() {
  ...
  if FM_HOME="$home" FM_SPAWN_NO_GUARD=1 \
    "$ROOT/bin/fm-spawn.sh" remote-new --secondmate --model gpt-5 >/dev/null 2>"$err"; then
    kill "$holder" 2>/dev/null || true
