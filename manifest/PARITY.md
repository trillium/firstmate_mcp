...
- mirrored: **65**
- denied-by-design: **71** (deliberate refusals, each with a reason in COVERAGE.md)
- gap rows: **2** — of which removed-upstream **0**, current-upstream **2**
- fork extensions: **22** (trillium/firstmate additions, spine-classified, not upstream gaps)
