...
- `remote_entrypoint` (out of smarts-only scope)
- `remote_herdr_guard` (out of smarts-only scope)
- `remote_inherit` (out of smarts-only scope)
- `remote_provision` (out of smarts-only scope)
- `remote_seed` (out of smarts-only scope)
- `remote_worker` (out of smarts-only scope)
...
| --- | --- | --- | --- | --- |
| Fleet runs | 3 | 2 | 1 | 3 |
| Supervision | 13 | 23 | 0 | 4 |
| Sessions | 6 | 18 | 1 | 1 |
| Backlog / decisions | 5 | 1 | 0 | 7 |
...
refusal reason; gap is the explicitly unmirrored port backlog. Fork counts
trillium/firstmate extensions with no upstream counterpart (spine-classified).
<!-- GENERATED:END -->
