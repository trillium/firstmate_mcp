...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/claude-account.test.sh 489
tests/fm-afk-inject-e2e.test.sh 34309
tests/fm-afk-pi-herdr-return-e2e.test.sh 65
tests/fm-afk-return.test.sh 1290
tests/fm-ask-user-authority.test.sh 263
tests/fm-backend-cmux-smoke.test.sh 47
tests/fm-backend-cmux.test.sh 6521
tests/fm-backend-herdr-focus-flash-e2e.test.sh 54
tests/fm-backend-orca.test.sh 16240
tests/fm-backend-tmux-smoke.test.sh 372
tests/fm-backend-zellij-smoke.test.sh 23
tests/fm-backend-zellij.test.sh 6784
tests/fm-backend.test.sh 19627
tests/fm-backlog-handoff.test.sh 3268
tests/fm-backlog-import-beads.test.sh 43
tests/fm-bead-stamp.test.sh 324
tests/fm-beads-backend.test.sh 23072
tests/fm-beads-hooks.test.sh 2837
tests/fm-beads-resilience-lib.test.sh 4025
tests/fm-bearings-snapshot.test.sh 75713
tests/fm-bootstrap.test.sh 49720
tests/fm-busy-adapter-wiring.test.sh 14697
tests/fm-busy-state.test.sh 2869
tests/fm-calm-pi-extension.test.sh 241
tests/fm-claude-stop-autoarm-live-e2e.test.sh 22
tests/fm-claude-stop-autoarm.test.sh 60599
tests/fm-cmux-claude-composer-live-e2e.test.sh 25
tests/fm-codex-continuity-live-e2e.test.sh 22
tests/fm-control-relaunch.test.sh 27285
tests/fm-control.test.sh 35908
tests/fm-daemon.test.sh 24167
tests/fm-decision-hold-beads.test.sh 43
tests/fm-documentation-audiences.test.sh 789
tests/fm-fleet-snapshot-view.test.sh 9106
tests/fm-fleet-sync.test.sh 19007
tests/fm-fork-origin-check.test.sh 171
tests/fm-gate-refuse.test.sh 4069
tests/fm-gitignore-config.test.sh 30
tests/fm-gotmp.test.sh 1673
tests/fm-grok-continuity-live-e2e.test.sh 23
tests/fm-grok-stop-live-e2e.test.sh 50
tests/fm-groom.test.sh 485
tests/fm-guard-stale-banner.test.sh 5875
tests/fm-harness-liveness-drift-live-e2e.test.sh 22
tests/fm-hash-pane.test.sh 436
tests/fm-herdr-session-cleanup.test.sh 5824
tests/fm-herdr-spur.test.sh 360
tests/fm-herdr-version-floor-live-e2e.test.sh 21
tests/fm-hook-artifacts-not-tracked.test.sh 45
tests/fm-idea-mine.test.sh 41
tests/fm-kimi-harness.test.sh 14334
tests/fm-ledger.test.sh 256
tests/fm-muse-harness.test.sh 26582
tests/fm-muse-signals-live-e2e.test.sh 24
tests/fm-on.test.sh 8526
tests/fm-opencode-primary-live-e2e.test.sh 22
tests/fm-operational-input.test.sh 220
tests/fm-pending-reply.test.sh 17346
tests/fm-pi-primary-live-e2e.test.sh 22
tests/fm-pi-watch-extension.test.sh 16935
tests/fm-pool-reclaim.test.sh 3514
tests/fm-pr-check-security.test.sh 275919
tests/fm-procevent.test.sh 50494
tests/fm-project-dir.test.sh 705
tests/fm-project-origin.test.sh 110
tests/fm-public-followup.test.sh 41358
tests/fm-quota-array-dispatch-live-e2e.test.sh 21
tests/fm-remote-backlog-handoff.test.sh 20045
tests/fm-remote-doctor.test.sh 7432
tests/fm-remote-entrypoint.test.sh 124
tests/fm-remote-job-orphan-reap.test.sh 2950
tests/fm-remote-job.test.sh 47911
tests/fm-remote-launch.test.sh 893
tests/fm-remote-reply.test.sh 23574
tests/fm-remote-secondmate-home-selection.test.sh 453
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 195604
tests/fm-remote-secondmate-parent-binding.test.sh 14077
tests/fm-remote-secondmate-trace-context.test.sh 36633
tests/fm-review-decision.test.sh 408
tests/fm-review-page.test.sh 41
tests/fm-secondmate-harness.test.sh 121724
tests/fm-secondmate-lifecycle-e2e.test.sh 10644
tests/fm-secondmate-liveness.test.sh 31723
tests/fm-secondmate-safety.test.sh 50770
tests/fm-secondmate-sync.test.sh 16695
tests/fm-send-raw.test.sh 743
tests/fm-send-resolve-key.test.sh 7804
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 48
tests/fm-send-secondmate-marker.test.sh 20525
tests/fm-send-verify-transition.test.sh 4409
tests/fm-session-lock-ancestry.test.sh 1150
tests/fm-session-start.test.sh 124145
tests/fm-sessionstart-hook-live-e2e.test.sh 21
tests/fm-sessionstart-nudge.test.sh 16671
tests/fm-shared-captain-inheritance.test.sh 5075
tests/fm-spawn-account.test.sh 4052
tests/fm-spawn-beads.test.sh 11992
tests/fm-spawn-dispatch-profile.test.sh 44145
tests/fm-spawn-parlay.test.sh 6461
tests/fm-spawn-reused-worktree-hooks.test.sh 5305
tests/fm-spawn-worktree-settle.test.sh 4831
tests/fm-startup-memory-budget.test.sh 12158
tests/fm-startup-network.test.sh 49061
tests/fm-stow-cascade.test.sh 3077
tests/fm-subagent-pretool-check.test.sh 1345
tests/fm-supervision-events.test.sh 480
tests/fm-tangle-guard.test.sh 9098
tests/fm-task-delivery.test.sh 2272
tests/fm-teardown-endpoint-safety.test.sh 3957
tests/fm-teardown.test.sh 98361
tests/fm-test-affected.test.sh 10849
tests/fm-test-fixture-cleanup.test.sh 1279
tests/fm-test-isolation-proof.test.sh 1288
tests/fm-test-parlay-guard.test.sh 581
tests/fm-tmux-agent-liveness.test.sh 971
tests/fm-trace-context-lib.test.sh 216
tests/fm-trace-context-spawn.test.sh 43188
tests/fm-turnend-guard.test.sh 33776
tests/fm-update.test.sh 4890
tests/fm-vendor-auth-probe.test.sh 43341
tests/fm-wake-daemon-lifecycle-e2e.test.sh 4852
tests/fm-wake-drain-open-decisions-cursor.test.sh 6642
tests/fm-wake-drain-open-decisions.test.sh 3281
tests/fm-wake-queue.test.sh 27694
tests/fm-watch-arm.test.sh 27813
tests/fm-watch-checkpoint.test.sh 4611
tests/fm-watch-cycle-lib.test.sh 294
tests/fm-watch-triage.test.sh 112689
tests/fm-watcher-lock.test.sh 104490
tests/hash-probe-defect.test.sh 136
EOF
}
